(function() {
  ...
  style.textContent = [
    ...
    "  padding: clamp(48px,7vw,72px) clamp(24px,6vw,80px) 0;",
    "  text-align: center;",
    "}",
    ".footer-cta-inner { max-width: 720px; margin: 0 auto; border: 1.5px solid rgba(137,24,26,0.35); border-bottom: none; border-radius: 14px 14px 0 0; background: #FFFDFA; padding: clamp(36px,5vw,48px) clamp(28px,5vw,52px) clamp(40px,5vw,52px); box-shadow: 0 -2px 22px rgba(137,24,26,0.05); position: relative; top: 1px; }",
    ".footer-cta-eyebrow {",
    "  font-family: var(--font-ui); font-size: 11px; font-weight: 600;",
    "  letter-spacing: 0.14em; text-transform: uppercase;",
    "  color: #89181A; margin-bottom: 16px;",
    "}",
    ".footer-cta h2 {",
    "  font-family: var(--font-serif); font-size: clamp(28px,4.5vw,44px);",
    "  font-weight: 400; color: #1A1410; line-height: 1.25; margin: 0 0 16px;",
    "}",
    ".footer-cta h2 em { font-style: italic; color: #89181A; }",
    ".footer-cta p {",
  ...
  var html = '<section class="footer-cta">'
    ...
    + '<a href="https://go.trueluvtake2.com/contact" target="_blank" rel="noopener">Contact Us</a>'
    ...
    + '<a href="https://go.trueluvtake2.com/contact" target="_blank" rel="noopener">Contact</a>'
    + '</div></div>'
